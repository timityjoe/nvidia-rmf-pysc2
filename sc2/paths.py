...
BASEDIR = {
    ...
    # Mod by Tim:
    # "Linux": "~/StarCraftII",
    "Linux": "/media/rosi/DataSSD/workspace/rmf2_ws_foxy/AlphaStar/Games/Battlenet/drive_c/Program Files (x86)/StarCraft II",
...
def get_runner_args(cwd):
    print("get_runner_args()")
    if "WINE" in os.environ:
        print(" WINE in env detected!")
